...
- **Pronto para Impressão:** A página deve possuir CSS avançado para impressão em formato de apostila A4 Retrato, de forma que não quebre o layout ao imprimir.
